...
module.exports = (sequelize, DataTypes) => {
  class invoice_log_details extends Model {
    /**
    ...
    static associate(models) {
      ...
      //     as: "itemModel",
      //   });
      this.belongsTo(models.invoice_log, {
        foreignKey: "invoice_id",
        as: "invoice_log_Model",
      });
    }
  }
  invoice_log_details.init(
    {
    ...
    {
      sequelize,
      modelName: "invoice_log_details",
      tableName: "invoice_log_details",
      timestamps: true,
      paranoid: true,
