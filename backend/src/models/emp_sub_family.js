...
module.exports = (sequelize, DataTypes) => {
  class emp_sub_family extends Model {
    /**
  ...
  emp_sub_family.init(
    {
      ...
      emp_sub_famcode: DataTypes.STRING(255),
      emp_sub_famname: DataTypes.STRING(255),
      emp_sub_famlong: DataTypes.STRING(255),
      emp_sub_fdeptname: DataTypes.STRING(255),
    ...
    {
      sequelize,
      modelName: "emp_sub_family",
      tableName: "emp_sub_family",
      timestamps: true,
      paranoid: true,
