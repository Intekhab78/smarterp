...
function Warehouse() {
  ...
  const handleClickOpen = (warehouseData) => {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <MDButton
          ...
          color="info"
          component={Link}
          to={`/master/warehouse/edit/${params.row.uuid}`}
        >
      ...
      >
        ...
        <DialogContent className="dialog-content">
          <Typography gutterBottom style={{ fontSize: "20" }}>
            Are you sure want to delete this record {warehouseData.name}??
          </Typography>
        </DialogContent>
