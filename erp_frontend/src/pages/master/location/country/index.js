...
function Country() {
  ...
  const handleClickOpen = (countryData) => {
  ...
  const columns = [
    ...
    { field: "country_code", headerName: "COUNTRY CODE", width: 200 },
    { field: "dial_code", headerName: "DIAL CODE", width: 200 },
    {
      field: "currency_code",
    ...
    },
    {
      ...
      renderCell: (params) => (
        <MDButton
          ...
          color="info"
          component={Link}
          to={`/master/country/edit/${params.row.uuid}`}
        >
              ...
              >
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={1} ml={30}>
                    <MDTypography component={Link} to="/master/country">
