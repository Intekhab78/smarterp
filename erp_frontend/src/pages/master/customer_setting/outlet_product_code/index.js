...
function Outlet_product() {
  ...
  const handleClickOpen = (outletData) => {
  ...
  const handleClosed = () => {
   ...
   const handleDelete = async () => {
    ...
    const { uuid } = outletData;
    setOpen(false);
    await axios
      .get("outlet-product/delete/" + uuid)
      .then((response) => {
        getdetails();
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 100,
      renderCell: (params) => (
        <MDButton variant="text" color="info" component={Link} to="/master/outlet/edit">
      ...
      >
        ...
        <DialogContent className="dialog-content">
          <Typography gutterBottom style={{ fontSize: "20" }}>
            Are you sure want to delete this record {outletData.name}??
          </Typography>
        </DialogContent>
              ...
              >
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={1} ml={40}>
                    <MDTypography component={Link} to="/master/outlet-product">
