...
export default function Cashier_Reciept() {
  ...
  const handleClickOpen = (cashierData) => {
  ...
  //   const { uuid } = cashierData;
  //   setOpen(false);
  //   await axios
  //     .get("cashierreciept/delete/" + uuid)
  //     .then((response) => {
  //       getdetails();
  ...
  const getdetails = () => {
    ...
    const response = axios
      .post("cashierreciept/list", payload)
      .then((response) => {
  ...
  const columns = [
    ...
    { field: "cashier_reciept_number", headerName: "CODE", width: 130 },
    {
      field: "salesman",
    ...
    },
    {
      ...
      width: 200,
      renderCell: (params) => params?.value?.route_code + " ",
    },
    { field: "total_amount", headerName: "AMOUNT", width: 150 },
    {
      ...
      headerName: "STATUS",
      width: 150,
      renderCell: (params) => (params.row.status === 1 ? "Verified" : "Unverified"),
    },
    // {
    //   width: 100,
    //   renderCell: (params) => (
      ...
      >
        ...
        <DialogContent className="dialog-content">
          <Typography gutterBottom style={{ fontSize: "20" }}>
            Are you sure want to delete this record {cashierData.salesman}??
          </Typography>
        </DialogContent>
              ...
              >
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={1} ml={35}>
                    <MDTypography component={Link} to="/master/cashier-reciept/add">
