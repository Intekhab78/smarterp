...
export default function ReportTypes({ data, loading }) {
    ...
    const columns = [
        ...
        },
        {
            ...
            sortable: true,
            disableColumnMenu: true,
            renderCell: (params) => params?.row?.orderModel?.customer === null ? "-" : params?.row?.orderModel?.customer?.customerInfo?.customer_code + " - " + params?.row?.orderModel?.customer?.firstname,
        },
        {
            field: "salesman",
            ...
            sortable: true,
            disableColumnMenu: true,
            renderCell: (params) => params?.row?.orderModel?.salesman === null ? "-" : params?.row?.orderModel?.salesman?.salesmanInfo?.salesman_code + " - " + params?.row?.orderModel?.salesman?.firstname + " " + params?.row?.orderModel?.salesman?.lastname,
        },
        {
