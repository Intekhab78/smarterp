...
export default function item() {
  ...
  const handlePrintToZebra = async (uuid) => {
    ...
    try {
      ...
      canvas.width = barcodeWidth + 40;
      canvas.height = barcodeHeight + 150;
      ...
      // ---------- PRICE ----------
      ctx.font = "14px Arial";
      ctx.fillText(itemprice || "", canvas.width / 2, 20 + nameHeight + 10);
      ...
      const barcodeY = 20 + nameHeight + 30;
      ctx.drawImage(barcodeCanvas, 20, barcodeY, barcodeWidth, barcodeHeight);

      // ---------- UPC TEXT ----------
      ctx.font = "16px monospace";
      ctx.fillText(itemupc, canvas.width / 2, barcodeY + barcodeHeight + 25);
