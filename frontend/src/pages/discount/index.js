...
export default function Discount() {
  ...
  const handleClickOpen = (discountData) => {
  ...
  const handleClosed = () => {
   ...
   const handleDelete = async () => {
    ...
    const { uuid } = discountData;
    setOpen(false);
    await axios
      .get("discount/delete/" + uuid)
      .then((response) => {
        getdetails();
      ...
      >
        ...
        <DialogContent className="dialog-content">
          <Typography gutterBottom style={{ fontSize: "20" }}>
            Are you sure want to delete this record {discountData.name}??
          </Typography>
        </DialogContent>
              ...
              >
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={1} ml={40}>
                    <MDTypography component={Link} to="/master/discount">
